                                ...
                                if (stack.is(Items.nightmare_base_start.get())) {
                                    if (stack.get(DataReg.tag) != null) {
                                        if (event.getEntity() instanceof Warden warden) {
                                            if (!stack.get(DataReg.tag).getBoolean(wolf).isPresent()) {
                                ...
                                if (stack.get(DataReg.tag) != null) {
                                    if (event.getEntity() instanceof EnderDragon enderDragon) {
                                        if (player.getMainHandItem().isEmpty()&&player.hasEffect(MobEffects.WITHER)) {
                                            if (!stack.get(DataReg.tag).getBoolean(hypocritical_self_esteem).isPresent()) {
                        ...
                        for (Map.Entry<String, ICurioStacksHandler> entry : curios.entrySet()) {
                            ...
                            for (int i = 0; i < stacksHandler.getSlots(); i++) {
                                ...
                                if (stack.is(Items.nightmare_base_insight.get())) {
                                    if (stack.get(DataReg.tag) != null) {
                                        if (!stack.get(DataReg.tag).getBoolean(ring).isPresent()) {
                                ...
                                if (stack.get(DataReg.tag) != null) {
                                    if (event.getEntity() instanceof LivingEntity warden) {
                                        if (warden.getMaxHealth()>=player.getMaxHealth()*30){
                                            if (!stack.get(DataReg.tag).getBoolean(apple).isPresent()) {
                            ...
                            if (stack.is(Items.nightmare_base_start.get())) {
                                if (stack.get(DataReg.tag) != null) {
                                    if (event.getEntity() instanceof Sniffer warden) {
                                        if (!stack.get(DataReg.tag).getBoolean(nightmare_base_start_egg).isPresent()) {
                    ...
                    for (Map.Entry<String, ICurioStacksHandler> entry : curios.entrySet()) {
                        ...
                        for (int i = 0; i < stacksHandler.getSlots(); i++) {
                            ...
                            if (stack.is(Items.nightmare_base_stone.get())) {
                                if (stack.get(DataReg.tag) != null) {
                                    if (event.getEntity() instanceof Warden warden) {
                                        if (!stack.get(DataReg.tag).getBoolean(end_bone).isPresent()) {
                    ...
                    for (Map.Entry<String, ICurioStacksHandler> entry : curios.entrySet()) {
                        ...
                        for (int i = 0; i < stacksHandler.getSlots(); i++) {
                            ...
                            if (stack.is(Items.nightmare_base_start.get())) {
                                if (stack.get(DataReg.tag) != null) {
                                    if (event.getEntity() instanceof Warden warden) {
                                        if (!stack.get(DataReg.tag).getBoolean(nightmare_base_start_power).isPresent()) {
                            ...
                            if (stack.is(Items.nightmare_base_insight.get())) {
                                if (stack.get(DataReg.tag) != null) {
                                    if (event.getEntity() instanceof EnderDragon warden) {
                                        if (!stack.get(DataReg.tag).getBoolean(nightmare_base_insight_collapse).isPresent()) {
                ...
                CuriosApi.getCuriosInventory(player).ifPresent(handler -> {
                    ...
                    for (Map.Entry<String, ICurioStacksHandler> entry : curios.entrySet()) {
                        ...
                        for (int i = 0; i < stacksHandler.getSlots(); i++) {
                            ...
                            if (stack.is(Items.nightmare_base_insight.get())) {
                                if (stack.get(DataReg.tag) != null) {
                                    if (!stack.get(DataReg.tag).getBoolean(nightmare_base_insight_insane).isPresent()) {
                    ...
                    for (Map.Entry<String, ICurioStacksHandler> entry : curios.entrySet()) {
                        ...
                        for (int i = 0; i < stacksHandler.getSlots(); i++) {
                            ...
                            if (stack.is(Items.nightmare_base_fool.get())) {
                                if (stack.get(DataReg.tag) != null) {
                                    if (event.getEntity() instanceof EnderDragon warden) {
                                        if (!stack.get(DataReg.tag).getBoolean(nightmare_base_fool_betray).isPresent()) {
                            ...
                            if (stack.is(Items.nightmare_base_fool.get())) {
                                if (stack.get(DataReg.tag) != null) {
                                    if (event.getEntity() instanceof Warden warden) {
                                        if (!stack.get(DataReg.tag).getBoolean(nightmare_base_fool_bone).isPresent()) {
                            ...
                            if (stack.is(Items.nightmare_base_fool.get())) {
                                if (stack.get(DataReg.tag) != null) {
                                    if (event.getEntity() instanceof WitherBoss warden) {
                                        if (!stack.get(DataReg.tag).getBoolean(nightmare_base_fool_soul).isPresent()) {
                            ...
                            if (stack.is(Items.nightmare_base_redemption.get())) {
                                if (stack.get(DataReg.tag) != null) {
                                    if (event.getEntity() instanceof Villager raider) {
                                        if (stack.get(DataReg.tag).getInt(nightmare_base_redemption_degenerate).isPresent()) {
                                            if (stack.get(DataReg.tag).getInt(nightmare_base_redemption_degenerate).get() < 100) {
                                                stack.get(DataReg.tag).putInt(nightmare_base_redemption_degenerate, stack.get(DataReg.tag).getInt(nightmare_base_redemption_degenerate).get() + 1);
                                            } else if (stack.get(DataReg.tag).getInt(nightmare_base_redemption_degenerate).get() == 100) {
                                                player.addItem(new ItemStack(Items.nightmare_base_redemption_degenerate.get()));
                                                stack.get(DataReg.tag).putInt(nightmare_base_redemption_degenerate, stack.get(DataReg.tag).getInt(nightmare_base_redemption_degenerate).get() + 1);
                                            }
                                        }else {
                                            stack.get(DataReg.tag).putInt(nightmare_base_redemption_degenerate,1);
                                        }
                                    }
                                }
                            }
                            ...
                            if (stack.is(Items.nightmare_base_redemption.get())) {
                                if (stack.get(DataReg.tag) != null) {
                                    if (event.getEntity() instanceof Raider raider) {
                                        if (stack.get(DataReg.tag).getInt(nightmare_base_redemption_deception).isPresent()) {
                                            if (stack.get(DataReg.tag).getInt(nightmare_base_redemption_deception).get() < 100) {
                                                stack.get(DataReg.tag).putInt(nightmare_base_redemption_deception, stack.get(DataReg.tag).getInt(nightmare_base_redemption_deception).get() + 1);
                                            } else if (stack.get(DataReg.tag).getInt(nightmare_base_redemption_deception).get() == 100) {
                                                player.addItem(new ItemStack(Items.nightmare_base_redemption_deception.get()));
                                                stack.get(DataReg.tag).putInt(nightmare_base_redemption_deception, stack.get(DataReg.tag).getInt(nightmare_base_redemption_deception).get() + 1);
                                            }
                                        }else {
                                            stack.get(DataReg.tag).putInt(nightmare_base_redemption_deception,1);
                    ...
                    for (Map.Entry<String, ICurioStacksHandler> entry : curios.entrySet()) {
                        ...
                        for (int i = 0; i < stacksHandler.getSlots(); i++) {
                            ...
                            if (stack.is(Items.nightmare_base_reversal.get())) {
                                if (stack.get(DataReg.tag) != null) {
                                    if (event.getEntity() instanceof EnderDragon warden) {
                                        if (!stack.get(DataReg.tag).getBoolean(nightmare_base_reversal_card).isPresent()) {
                    ...
                    for (Map.Entry<String, ICurioStacksHandler> entry : curios.entrySet()) {
                        ...
                        for (int i = 0; i < stacksHandler.getSlots(); i++) {
                            ...
                            if (stack.is(Items.nightmare_base_stone.get())) {
                                if (stack.get(DataReg.tag) != null) {
                                    if (event.getEntity() instanceof EnderDragon warden) {
                                        if (!stack.get(DataReg.tag).getBoolean(nightmare_base_stone_meet).isPresent()) {
                    ...
                    CuriosApi.getCuriosInventory(player).ifPresent(handler -> {
                        ...
                        for (Map.Entry<String, ICurioStacksHandler> entry : curios.entrySet()) {
                            ...
                            for (int i = 0; i < stacksHandler.getSlots(); i++) {
                                ...
                                if (stack.is(Items.nightmare_base_stone.get())) {
                                    if (stack.get(DataReg.tag) != null) {
                                        if (!stack.get(DataReg.tag).getBoolean(nightmare_base_stone_virus).isPresent()) {
                            ...
                            if (stack.is(Items.nightmare_base_stone.get())) {
                                if (stack.get(DataReg.tag) != null) {
                                    if (event.getEntity() instanceof Zombie warden) {
                                        if (!stack.get(DataReg.tag).getBoolean(nightmare_base_stone_brain).isPresent()) {
                            ...
                            for (Map.Entry<String, ICurioStacksHandler> entry : curios.entrySet()) {
                                ...
                                for (int i = 0; i < stacksHandler.getSlots(); i++) {
                                    ...
                                    if (stack.is(Items.nightmare_base_black_eye.get())) {
                                        if (stack.get(DataReg.tag) != null) {
                                            if (!stack.get(DataReg.tag).getBoolean(nightmare_base_black_eye_heart).isPresent()){
                    ...
                    for (Map.Entry<String, ICurioStacksHandler> entry : curios.entrySet()) {
                        ...
                        for (int i = 0; i < stacksHandler.getSlots(); i++) {
                            ...
                            if (stack.is(Items.nightmare_base_black_eye.get())) {
                                if (stack.get(DataReg.tag) != null) {
                                    if (event.getEntity() instanceof Warden warden) {
                                        if (!stack.get(DataReg.tag).getBoolean(nightmare_base_black_eye_eye).isPresent()) {
                ...
                CuriosApi.getCuriosInventory(player).ifPresent(handler -> {
                    ...
                    for (Map.Entry<String, ICurioStacksHandler> entry : curios.entrySet()) {
                        ...
                        for (int i = 0; i < stacksHandler.getSlots(); i++) {
                            ...
                            if (stack.is(Items.nightmare_base_black_eye.get())) {
                                if (stack.get(DataReg.tag) != null) {
                                    if (!stack.get(DataReg.tag).getBoolean(nightmare_base_black_eye_red).isPresent()) {
                    ...
                    for (Map.Entry<String, ICurioStacksHandler> entry : curios.entrySet()) {
                        ...
                        for (int i = 0; i < stacksHandler.getSlots(); i++) {
                            ...
                            if (stack.is(Items.nightmare_base_reversal_orb.get())) {
                                if (stack.get(DataReg.tag) != null) {
                                    if (!stack.get(DataReg.tag).getBoolean(nightmare_base_reversal_mysterious).isPresent()) {
                        ...
                        for (int i = 0; i < stacksHandler.getSlots(); i++) {
                            ...
                            if (stack.is(Items.nightmare_base_start.get())) {
                                if (Mth.nextInt(RandomSource.create(),1,100)<=25) {
                                    if (stack.get(DataReg.tag) != null) {
                                        if (!stack.get(DataReg.tag).getBoolean(nightmare_base_start_pod).isPresent()) {
                        ...
                        for (int i = 0; i < stacksHandler.getSlots(); i++) {
                            ...
                            if (stack.is(Items.nightmare_base_black_eye.get())) {
                                if (Mth.nextInt(RandomSource.create(),1,100)<=75) {
                                    if (stack.get(DataReg.tag) != null) {
                                        if (!stack.get(DataReg.tag).getBoolean(tricky_puppets).isPresent()) {
