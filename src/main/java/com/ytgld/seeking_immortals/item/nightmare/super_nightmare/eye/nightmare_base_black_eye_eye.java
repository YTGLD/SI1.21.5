...
public class nightmare_base_black_eye_eye extends nightmare implements SuperNightmare {
    ...
    public nightmare_base_black_eye_eye(Properties properties) {
        super(properties);
    }
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, TooltipDisplay tooltipDisplay, Consumer<Component> tooltipAdder, TooltipFlag flag) {
        ...
        tooltipAdder.accept(Component.translatable("item.nightmare_base_black_eye_eye.tool.string").withStyle(ChatFormatting.DARK_RED));
        tooltipAdder.accept(Component.translatable("item.nightmare_base_black_eye_eye.tool.string.1").withStyle(ChatFormatting.DARK_RED));
        tooltipAdder.accept(Component.translatable("item.nightmare_base_black_eye_eye.tool.string.2").withStyle(ChatFormatting.DARK_RED));
    }
    ...
    public void curioTick(SlotContext slotContext, ItemStack stack) {
        ...
        if (entity instanceof LivingEntity living0) {
            ...
            living0.addEffect(new MobEffectInstance(MobEffects.SLOWNESS, 30, 5));
